...
public class EscapeSequences {
    ...
    public static final String SET_BG_COLOR_LIGHT_BROWN = SET_BG_COLOR + "180m";  // light tan
    public static final String SET_BG_COLOR_DARK_BROWN  = SET_BG_COLOR + "94m";   // slightly darker brown
